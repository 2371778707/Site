...
import com.ch.site.view.DragView;
import com.ch.site.view.MyAboutView;
import com.ch.site.view.MyDialog;
import com.ch.site.view.MyDialogC;
import com.ch.site.view.MyDialogS;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.search:
                final MyDialogS dialogS =new MyDialogS(db,this,R.style.MyDialog);
                dialogS.setSearchClickLisenter(new MyDialogS.OnSearchClickLisenter() {
                    @Override
                ...
                break;
            case R.id.about:
                dialog = new MyAboutView(this,R.style.MyDialog);
                dialog.show();
                break;
            default:
                break;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.newi:
                final MyDialog dialog = new MyDialog(null,this,R.style.MyDialog);
                dialog.setOkOnclickListener("添加", new MyDialog.onOkOnclickListener() {
                    @Override
                ...
                dialog.setCancelOnclickListener("取消", new MyDialog.onCancelOnclickListener() {
                    @Override
            ...
            case R.id.modify:
                ...
                if (cursor.moveToNext()) {
                    ...
                    final MyDialogC dialog1 = new MyDialogC(db, this, R.style.MyDialog);
                    dialog1.setOkOnclickListener("确定", new MyDialogC.onOkOnClickListener() {
                        @Override
                        public void onOkOnclick() {
                    ...
                    dialog1.setCancelOnclickListener("取消", new MyDialogC.onCancelOnclickListener() {
                        @Override
                        public void onCancelClick() {
                            dialog1.dismiss();
                        }
                    ...
                    dialog1.setSpinOnitemClickLisenter(new MyDialogC.onSpinOnitemClickListener() {
                        @Override
                ...
                if (!text.trim().equals("")) {
                    if (findByValue(text)) {
                        if (Patterns.WEB_URL.matcher(text).matches()&&URLUtil.isValidUrl(text)&&contain(text)) {
                                final MyDialog dialog = new MyDialog(text, this, R.style.MyDialog);
                                dialog.setOkOnclickListener("添加", new MyDialog.onOkOnclickListener() {
                                    @Override
                                    public void onOkOnclick() {
