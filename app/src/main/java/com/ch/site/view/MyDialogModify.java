...
public class MyDialogModify extends Dialog{
    private Button ok;
    ...
    public MyDialogModify(@NonNull Context context, String url)
    {
        super(context);
        value1.setText(url);
    }
    public MyDialogModify(SQLiteDatabase db, @NonNull Context context, int themeResId) {
